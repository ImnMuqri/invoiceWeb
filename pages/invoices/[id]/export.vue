  ...
  <div
    ...
    <div
      ...
      <div
        ...
        class="p-12 flex flex-col min-h-[900px] border border-slate-100 relative">
        ...
        <div
          class="mt-auto pt-6 border-t border-slate-100 flex justify-end text-end opacity-50">
          <div
      ...
      <div
        ...
        class="flex flex-col min-h-[900px] bg-slate-50 overflow-hidden border border-slate-200 relative">
        <!-- Modern Header -->
        <div class="bg-slate-900 text-white p-12 relative overflow-hidden">
          ...
          <div class="relative z-10 flex justify-between items-start">
            <div>
              <UiLogo
                class="h-10 mb-8 brightness-0 invert opacity-90"
                :show-text="false"
                user-logo />
              <h1
