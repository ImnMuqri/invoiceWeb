                ...
                <tr
                  ...
                  <td
                    ...
                    <button
                      ...
                      class="inline-flex items-center justify-center rounded-md border border-slate-200 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 shadow-sm hover:bg-slate-50 transition-colors">
                      <svg
                        class="w-3.5 h-3.5 mr-1.5 text-[#25D366]"
                        fill="currentColor"
                        viewBox="0 0 24 24">
                        <path
            ...
            <div class="mt-3 sm:mt-5">
              ...
              <div
                ...
                <p
                  ...
                  Hi boss! Just a gentle reminder regarding invoice
                  <span class="font-semibold">{{ selectedInvoice?.id }}</span>
                  for
                  <span class="font-semibold"
                    >{{ selectedInvoice?.currency }}
                    {{ selectedInvoice?.amount.toLocaleString() }}</span
                  >. We noted there is an outstanding amount and wanted to
                  provide an easy payment option via our secure FPX / DuitNow
                  gateway: https://pay.invomate.my/inv/{{
                    selectedInvoice?.id.replace("INV-", "")
                  }}

                  Let us know if you have any questions. Thank you for your
                  business! 🙏
                </p>
                <div
