  ...
  <div class="pdoc">
    <div class="pdoc__inner">
      ...
      <div v-else class="pdoc__paper">
        ...
        <!-- Standing and reference ride the letterhead row — same rule as the
             pay page, so the two public documents keep one shape. -->
        ...
        <!-- Subject on the left, price and dates on the right -->
      ...
      <!-- Ours, at the foot and nowhere else. Same placement, same weight and
           now the same RULE as /pay/:id: the server answers it once, from the
           account's own attribution setting, rather than this page checking the
           plan and reaching a different answer than the invoice that follows.

           A tracked link rather than plain text, for the reason spec 09 gives —
           a signup arriving from a document somebody was sent is the clearest
           evidence the loop works, and it is invisible without the tag. -->
      <div v-if="quote?.attribution" class="pdoc__foot">
        <a
          :href="quote.attribution.url"
          target="_blank"
          rel="noopener"
          class="pdoc__mark">
          <!-- alt="" on purpose: the text beside it already names us. -->
