  ...
  <div class="advanced-analytics space-y-8">
    ...
    <div
      ...
      <div class="lg:col-span-8 space-y-8">
        <!-- Revenue Trends -->
        <div
          class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div class="lg:col-span-4 space-y-8">
        ...
        <!-- System Health Card -->
        <div
          class="bg-slate-900 rounded-xl p-6 shadow-xl relative overflow-hidden group">
          <div
          ...
          <div class="flex items-center gap-2 mb-8 relative z-10">
            ...
            <h3
              class="text-xs font-bold text-slate-300 uppercase tracking-[0.2em]">
              System Health
            </h3>
          </div>
