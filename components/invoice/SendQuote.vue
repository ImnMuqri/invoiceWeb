  ...
  <section class="card" aria-labelledby="send-quote">
    ...
    <div class="deliver">
      ...
      <p v-if="answered" class="f__hint">
        ...
        can still download the PDF or open it in WhatsApp for your records.
      </p>
      ...
      <p class="f__hint">
        ...
        reaches them until you press send there, and it costs nothing. Needs a
        phone number on the client's record.
        <template v-if="!answered">
