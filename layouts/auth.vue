<template>
  <div style="zoom: 0.9">
    <div
      class="min-h-[111.11vh] bg-[#f8fafc] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      <!-- Back Button -->
      ...
      <div class="relative z-10 w-full max-w-md mx-auto">
        <NuxtLink
          to="/"
          class="flex justify-center items-center gap-2 text-2xl font-bold tracking-tighter text-slate-900 mb-8 hover:opacity-80 transition-opacity">
          <svg
